---
title: 'STAA 577: Laboratory Ten </br> `tidyverse` version'
...
pr.out <- stats::prcomp(USArrests, scale = TRUE)
...
set.seed(3)
km_3_1start <- clust_data %>%
  stats::kmeans(3, nstart = 1)
...
# Using (a) complete - compute all pairwise distances and choose the largest
