...
v1 <- ggplot2::qplot(x = seq_along(pve),  # convenience wrapper `qqplot()`
...
<!--
# SJT:
* Note change to correlation example
  + Yeah, this example looks a little off, I labeled the chunk as 
    "doubtful" because I wasn't sure if you would keep it. In your class notes
    it doesn't look like you covered this example (though you may have verbally)
-->
