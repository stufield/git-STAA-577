...
# The S&P Stock Market Data `Smarket`
```{r Stock_Market_Data, error = TRUE}
class(Smarket)
names(Smarket)                           # List features/covariates available
dim(Smarket)                             # dimenstions of data
Smarket %>% head(10)                     # Top 10 rows of data frame
...
sum_tbl                           # take a look
sum_tbl %>% dplyr::pull(p.value)  # P-values for each covariate
