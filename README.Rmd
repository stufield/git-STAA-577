...
A fantastic reference for using GitHub with `R` and `RStudio` is free online
from [Jenny Bryan](https://github.com/jennybc). If you **ever** plan to use
verion control with `GitHub` I **strongly** recommend reading it in detail.
